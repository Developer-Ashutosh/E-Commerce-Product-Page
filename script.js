    ...
    cartBody.innerHTML = `
            <div class="first">
                <div class="selectedProduct">
                    <img src="${
                      document.querySelector("section.left .productImg img").src
                    }" alt="">
                </div>
                <div class="productDetails">
                    <div class="title">Fall Limited Edition Sneakers</div>
                    <div class="bill">$125.00 x <span class="finalQuantity">${
                      quantityDisplay.innerText
                    }</span> <span class="total">${
      "$" + 125.0 * parseInt(quantityDisplay.innerText) + ".00"
    }</span></div>
                </div>
  ...
  imageContainers.forEach((container) => {
    ...
    thumbnails.forEach((thumbnail) => {
      thumbnail.addEventListener("click", () => {
        ...
        container.querySelector(".productImg img").src =
...
const toggleImageLightbox = () => {
  document
    .querySelector("section.left .productImg")
